...
if "%version%" == "6.2" exit
if "%version%" == "6.1" exit
if "%version%" == "6.0" echo Hello there! seems like you opened the right file! Am i right? haha.
if "%version%" == "5,1" echo Hello there! seems like you opened the right file! Am i right? haha.
rem etc etc
endlocal
